...
//creating buttons and positions,width and height
    b1=new Button("1");  
    ...
    //performing event handling action
    //on each button
   ...
   add(b1);add(b2);add(b3);add(b4);add(b5);add(b6);add(b7);add(b8);add(b9);  
    setSize(500,400); //sets size of frame 
    setLayout(null);  //sets layout of frame
...
{  
    ...
    //completion code which indicates success on completion  
